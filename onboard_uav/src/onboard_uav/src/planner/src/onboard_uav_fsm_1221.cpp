...
void OnboardUavFsm::RunDockingLanding()
{
    ...
    case LandingStates::DESCEND_ABOVE_TARGET:
    {
        ...
        if (std::fabs(relative_pos.z()) < docking_param_.final_landing_height && horizontal_distance < docking_param_.horizontal_distance_tolerance)
        {
        ...
        target_pos_.z() = landing_target_pose_.pose.position.z + docking_param_.final_landing_height;
        target_vel_ = Eigen::Vector3d::Zero();
        //target_vel_.z() = -0.05;
    ...
    case LandingStates::FINAL_LANDING:
    {
        ...
        if (std::fabs(relative_pos.z()) < docking_param_.landing_complete_height && horizontal_distance > 0.18f)
        {
        ...
        P_target.type_mask =			//使用位置控制
        //mavros_msgs::PositionTarget::IGNORE_PX |
        //mavros_msgs::PositionTarget::IGNORE_PY |s
        //mavros_msgs::PositionTarget::IGNORE_PZ |
        mavros_msgs::PositionTarget::IGNORE_VX |
        mavros_msgs::PositionTarget::IGNORE_VY |
        mavros_msgs::PositionTarget::IGNORE_VZ |
