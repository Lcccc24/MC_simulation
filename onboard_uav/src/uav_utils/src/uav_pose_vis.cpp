...
void uav0_pose_callback(const geometry_msgs::PoseStamped::ConstPtr &msg)
{
    ...
    uav0_pose_vis.pose.position.x -= 1.0;
    uav0_pose_vis.scale.x = 2.5;
    uav0_pose_vis.scale.y = 2.5;
    uav0_pose_vis.scale.z = 2.5;
    uav0_pose_vis.color.a = 1.0;
    uav0_pose_vis.color.r = 40.0 / 255.0;
    uav0_pose_vis.color.g = 120.0 / 255.0;
    uav0_pose_vis.color.b = 255.0 / 255.0;
...
int main(int argc, char **argv)
{
    ...
    uav0_mesh_resource = "package://uav_utils/meshes/hummingbird.mesh";
    uav1_mesh_resource = "package://uav_utils/meshes/f250.dae";

    ros::Subscriber uav0_pose = nh.subscribe("/uav0/mavros/local_position/pose", 100, uav0_pose_callback);
    ros::Subscriber uav1_pose = nh.subscribe("/uav1/mavros/local_position/pose", 100, uav1_pose_callback);
